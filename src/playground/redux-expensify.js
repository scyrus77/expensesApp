...
const expense2 = store.dispatch(addExpense({ description: 'Books', amount: 200, createdAt: 5000}));
const expense3 = store.dispatch(addExpense({ description: 'Coffee', amount: 3000, createdAt: 1000}));
//
